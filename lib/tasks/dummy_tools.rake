...
TITLES = ["Abigaïl", "Avion de compétences", "Fishbowl", "Encore des mots", "Rapport machin chose", "Active listening",
"The five whys", "Diffusion Curve Reflection", "Court", "Bien bien plus très long nom d'outil", "Mash up innovation", "Exploring Client centricity", "Tous ensemble"]
